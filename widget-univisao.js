(function () {
    /* === PROVADOR PAUSADO (Univisão) — kill switch ===
       O widget carrega mas sai aqui, então nenhum selo/botão/prova aparece na loja.
       Para RELIGAR: remover este bloco (reverter este commit) e dar push — o
       GitHub Pages atualiza em ~2 min. Backend segue intacto. */
    console.log('[PL] Widget Univisao PAUSADO (kill switch).');
    return;
